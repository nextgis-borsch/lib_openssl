...
function(get_binary_package repo repo_type exact_version download_url name)
    ...
    if(repo_type STREQUAL "github") # TODO: Add gitlab here.
        ...
        foreach(asset_id ${api_request.assets})
            if(exact_version)
                string(FIND ${api_request.assets_${asset_id}.browser_download_url} ${exact_version}-${COMPILER} IS_FOUND)
            else()
                string(FIND ${api_request.assets_${asset_id}.browser_download_url} ${COMPILER} IS_FOUND)
            endif()
...
function(find_extproject name)
    ...
    if(BINARY_URL)
        ...
        if(OSX_FRAMEWORK)
            ...
            set(CMAKE_PREFIX_PATH ${EXT_INSTALL_DIR})
        endif()
        find_package(${name})
